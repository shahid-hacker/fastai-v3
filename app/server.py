...
export_file_url = 'https://drive.google.com/uc?export=download&id=12gSPgBkGNvijZcFFAxGVrw42LRMelFtg'
export_file_name = 'export.pkl'

classes = ['Abyssinian','Bengal','Birman','Bombay','British_Shorthair','Egyptian_Mau','Maine_Coon','Persian','Ragdoll','Russian_Blue','Siamese','Sphynx','american_bulldog',
...
async def analyze(request):
    ...
    str(final_result) = "Your " + animal + "is a " + breed 
